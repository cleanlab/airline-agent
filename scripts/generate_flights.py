...
def generate_direct_flights(start_date: datetime, num_days: int = 8, origin_airports: list = None, dest_airports: list = None) -> list[dict]:
...
def generate_connecting_flights(start_date: datetime, num_days: int = 8, origin_airports: list = None, dest_airports: list = None) -> list[dict]:
                ...
                for hub in HUB_AIRPORTS:
                    ...
                    for _ in range(num_routes):
                        ...
                        flight1 = {
                            ...
                            "origin": origin,
                            "destination": hub,
                            "departure": departure_time_leg1.strftime(f"%Y-%m-%dT%H:%M:00{departure_offset_leg1:+03d}:00"),
                        ...
                        flight2 = {
                            ...
                            "origin": hub,
                            "destination": destination,
                            "departure": departure_time_leg2.strftime(f"%Y-%m-%dT%H:%M:00{departure_offset_leg2:+03d}:00"),
...
def main():
    ...
    direct_flights_sf_to_nyc = generate_direct_flights(start_date, num_days=num_days, origin_airports=SF_AIRPORTS, dest_airports=NYC_AIRPORTS)
    ...
    direct_flights_nyc_to_sf = generate_direct_flights(start_date, num_days=num_days, origin_airports=NYC_AIRPORTS, dest_airports=SF_AIRPORTS)
    ...
    print(f"  - All flights are DIRECT flights for Halloween week 2025 (Oct 31 - Nov 7)")
    print(f"  - No connecting/transfer flights included")
