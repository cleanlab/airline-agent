...
class FlightDealInfo(BaseModel, frozen=True):
    ...
    departure_date: str = Field(..., description="Departure date information (e.g., 'Feb 3, 2026')")
    starting_price: int = Field(
        ..., description="Starting price for the flight in dollars as a whole number (e.g., 19)"
    )
