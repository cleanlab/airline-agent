...
- search_flight_deals — query the database of cheapest available fares on Frontier routes, returns origin/destination/fare type/departure date/starting price/last seen.
